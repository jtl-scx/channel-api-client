 ...
 * @link     https://openapi-generator.tech
 */
class EventSellerRelated implements ModelInterface, ArrayAccess
{
    ...
    public function setSellerId($seller_id)
    {
        ...
        if ((!preg_match("/^\\w{1,50}$/", $seller_id))) {
            throw new \InvalidArgumentException("invalid value for $seller_id when calling EventSellerRelated., must conform to the pattern /^\\w{1,50}$/.");
        }
