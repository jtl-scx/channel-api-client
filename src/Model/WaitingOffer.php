...
class WaitingOffer implements ModelInterface, ArrayAccess
{
    ...
    public function setSellerId($sellerId)
    {
        ...
        if ((!preg_match("/^\\w{1,50}$/", $sellerId))) {
            throw new \InvalidArgumentException("invalid value for $sellerId when calling WaitingOffer., must conform to the pattern /^\\w{1,50}$/.");
        }
    ...
    public function setOfferId($offerId)
    {
        ...
        if (($offerId < 1)) {
            throw new \InvalidArgumentException('invalid value for $offerId when calling WaitingOffer., must be bigger than or equal to 1.');
        }
    ...
    public function setSubTitle($subTitle)
    {
        if (!is_null($subTitle) && (mb_strlen($subTitle) > 255)) {
            throw new \InvalidArgumentException('invalid length for $subTitle when calling WaitingOffer., must be smaller than or equal to 255.');
        }
     ...
     *
     * @param \JTL\SCX\Client\Channel\Model\SalesChannelAttributeList[]|null $channelAttributeList A List of SalesChannel related attributes. Typicaly all required attributes need to be passed through this objects. Required (and also optinal) attributes can be requested using the /meta Data API endpoints.
     *
     * @return $this
     */
