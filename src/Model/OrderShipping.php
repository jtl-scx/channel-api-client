...
class OrderShipping implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function listInvalidProperties()
    {
        ...
        if ((count($this->container['shippingItems']) < 1)) {
    ...
    public function setOrderId($orderId)
    {
        if ((mb_strlen($orderId) > 150)) {
            throw new \InvalidArgumentException('invalid length for $orderId when calling OrderShipping., must be smaller than or equal to 150.');
        }
        if ((mb_strlen($orderId) < 1)) {
            throw new \InvalidArgumentException('invalid length for $orderId when calling OrderShipping., must be bigger than or equal to 1.');
        }
    ...
    public function setShippingItems($shippingItems)
    {
        ...
        if ((count($shippingItems) < 1)) {
            throw new \InvalidArgumentException('invalid length for $shippingItems when calling OrderShipping., number of items must be greater than or equal to 1.');
        }
