...
class OfferListingInProgress implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function setSellerId(string $sellerId): OfferListingInProgress
    {
    ...
    public function setOfferId(int $offerId): OfferListingInProgress
    {
    ...
    public function setStartedAt(\DateTime $startedAt): OfferListingInProgress
    {
