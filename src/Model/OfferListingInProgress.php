...
/**
 * OfferListingInProgress Class Doc Comment
 *
 * @category Class
 * @package  JTL\SCX\Client\Channel
 * @author   OpenAPI Generator team
 ...
 */
class OfferListingInProgress implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'OfferListingInProgress';
    ...
    public function setSellerId($sellerId)
    {
        ...
        if ((!preg_match("/^\\w{1,50}$/", $sellerId))) {
            throw new \InvalidArgumentException("invalid value for $sellerId when calling OfferListingInProgress., must conform to the pattern /^\\w{1,50}$/.");
        }
    ...
    public function setOfferId($offerId)
    {
        ...
        if (($offerId < 1)) {
            throw new \InvalidArgumentException('invalid value for $offerId when calling OfferListingInProgress., must be bigger than or equal to 1.');
        }
