 ...
 * @link     https://openapi-generator.tech
 */
class OfferListingInProgress implements ModelInterface, ArrayAccess
{
    ...
    public function setSellerId($seller_id)
    {
        ...
        if ((!preg_match("/^\\w{1,50}$/", $seller_id))) {
            throw new \InvalidArgumentException("invalid value for $seller_id when calling OfferListingInProgress., must conform to the pattern /^\\w{1,50}$/.");
        }
    ...
    public function setOfferId($offer_id)
    {
        ...
        if (($offer_id < 1)) {
            throw new \InvalidArgumentException('invalid value for $offer_id when calling OfferListingInProgress., must be bigger than or equal to 1.');
        }
