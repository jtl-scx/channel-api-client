 ...
 */
class SellerEventOrderCancellationAccepted implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function setSellerId(string $sellerId): SellerEventOrderCancellationAccepted
    {
    ...
    public function setOrderCancellationRequestId(string $orderCancellationRequestId): SellerEventOrderCancellationAccepted
    {
