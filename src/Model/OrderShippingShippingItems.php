...
class OrderShippingShippingItems implements ModelInterface, ArrayAccess
{
    ...
    protected static $openAPITypes = [
        'offer_id_list' => '\JTL\SCX\Client\Channel\Model\OrderShippingOfferIdList[]',
    ...
    {
        $this->container['offer_id_list'] = isset($data['offer_id_list']) ? $data['offer_id_list'] : null;
    ...
    {
        return $this->container['offer_id_list'];
    }

    /**
     * Sets offer_id_list
     *
     * @param \JTL\SCX\Client\Channel\Model\OrderShippingOfferIdList[]|null $offer_id_list Container to describe what items are included.
     *
     * @return $this
     */
    public function setOfferIdList($offer_id_list)
    {
        $this->container['offer_id_list'] = $offer_id_list;
