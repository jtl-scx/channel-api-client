...
class SellerEventOrderCancellationRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function setOrderCancellationRequestId(string $orderCancellationRequestId): SellerEventOrderCancellationRequest
    {
    ...
    public function setSellerId(string $sellerId): SellerEventOrderCancellationRequest
    {
    ...
    public function setOrderId(string $orderId): SellerEventOrderCancellationRequest
    {
    ...
    public function setOrderItem(array $orderItem): SellerEventOrderCancellationRequest
    {
    ...
    public function setCancelReason(?CancelReason $cancelReason): SellerEventOrderCancellationRequest
    {
    ...
    public function setMessage(?string $message): SellerEventOrderCancellationRequest
    {
