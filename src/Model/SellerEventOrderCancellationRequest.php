 ...
 */
class SellerEventOrderCancellationRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function setSellerId($sellerId)
    {
        ...
        if ((!preg_match("/^\\w{1,50}$/", $sellerId))) {
            throw new \InvalidArgumentException("invalid value for $sellerId when calling SellerEventOrderCancellationRequest., must conform to the pattern /^\\w{1,50}$/.");
        }
    ...
    public function setOrderId($orderId)
    {
        if ((mb_strlen($orderId) > 150)) {
            throw new \InvalidArgumentException('invalid length for $orderId when calling SellerEventOrderCancellationRequest., must be smaller than or equal to 150.');
        }
        if ((mb_strlen($orderId) < 1)) {
            throw new \InvalidArgumentException('invalid length for $orderId when calling SellerEventOrderCancellationRequest., must be bigger than or equal to 1.');
        }
    ...
    public function setMessage($message)
    {
        if (!is_null($message) && (mb_strlen($message) > 1024)) {
            throw new \InvalidArgumentException('invalid length for $message when calling SellerEventOrderCancellationRequest., must be smaller than or equal to 1024.');
        }
        if (!is_null($message) && (mb_strlen($message) < 0)) {
            throw new \InvalidArgumentException('invalid length for $message when calling SellerEventOrderCancellationRequest., must be bigger than or equal to 0.');
        }
