...
class OrderCancellationAccept implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function setSellerId(string $sellerId): OrderCancellationAccept
    {
    ...
    public function setOrderCancellationRequestId(string $orderCancellationRequestId): OrderCancellationAccept
    {
