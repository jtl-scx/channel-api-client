...
class Attribute implements ModelInterface, ArrayAccess
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['recommended'] = isset($data['recommended']) ? $data['recommended'] : false;
     ...
     * Gets values
     *
     * @return \JTL\SCX\Client\Channel\Model\AllowedValue[]|null
     */
     ...
     * Sets values
     *
     * @param \JTL\SCX\Client\Channel\Model\AllowedValue[]|null $values A set of possible choices for this specific attribute, in the form of a list of possible enumerations.
     *
     * @return $this
     */
     ...
     * Sets recommended
     *
     * @param bool|null $recommended A Channel may recommend to have a attribute set when lisitng a offer on a certain markatplace to gain more visibility and potential transactions.
     *
     * @return $this
     */
     ...
     * Sets enumValues
     *
     * @param string[]|null $enumValues (DEPRECATED - use values property instead) If the attribte type equals to ENUM this propertie must be set.
     *
     * @return $this
     */
