...
class OrderStatusOrderItems implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function setOrderItemId(string $orderItemId): OrderStatusOrderItems
    {
    ...
    public function setItemStatus(OrderItemStatus $itemStatus): OrderStatusOrderItems
    {
    ...
    public function getPaymentStatus(): OrderItemPaymentStatus
    {
        return $this->container['paymentStatus'];
    }

    public function setPaymentStatus(OrderItemPaymentStatus $paymentStatus): OrderStatusOrderItems
    {
