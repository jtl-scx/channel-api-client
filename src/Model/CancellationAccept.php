...
/**
 * CancellationAccept Class Doc Comment
 *
 * @category Class
 * @package  JTL\SCX\Client\Channel
 * @author   OpenAPI Generator team
 ...
 */
class CancellationAccept implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CancellationAccept';
    ...
    public function setSellerId(string $sellerId): CancellationAccept
    {
    ...
    public function setOrderCancellationRequestId(string $orderCancellationRequestId): CancellationAccept
    {
