 ...
 */
class CancellationDenied implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function setSellerId(string $sellerId): CancellationDenied
    {
    ...
    public function setOrderCancellationRequestId(string $orderCancellationRequestId): CancellationDenied
    {
    ...
    public function setReason(string $reason): CancellationDenied
    {
