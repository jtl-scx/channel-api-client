 ...
 */
class SupportedPaymentMethod implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function setPaymentMethodId(string $paymentMethodId): SupportedPaymentMethod
    {
    ...
    public function setDisplayName(?string $displayName): SupportedPaymentMethod
    {
