...
/**
 * ReturnReceived Class Doc Comment
 *
 * @category Class
 * @package  JTL\SCX\Client\Channel
 * @author   OpenAPI Generator team
 ...
 */
class ReturnReceived implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ReturnReceived';
    ...
    public function setSellerId(string $sellerId): ReturnReceived
    {
    ...
    public function setOrderId(string $orderId): ReturnReceived
    {
    ...
    public function setSellerReturnId(string $sellerReturnId): ReturnReceived
    {
    ...
    public function setChannelReturnId(?string $channelReturnId): ReturnReceived
    {
    ...
    public function setOrderItem(array $orderItem): ReturnReceived
    {
