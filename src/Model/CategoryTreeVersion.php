 ...
 * @link     https://openapi-generator.tech
 */
class CategoryTreeVersion implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CategoryTreeVersion';
    ...
    {
        $this->container['categoryTreeVersion'] = isset($data['categoryTreeVersion']) ? $data['categoryTreeVersion'] : null;
    }
     ...
     *
     * @param string|null $categoryTreeVersion categoryTreeVersion
     *
     * @return $this
     */
