 ...
 */
class CategoryTreeVersion implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function getCategoryTreeVersion(): ?string
    {
        return $this->container['categoryTreeVersion'];
    }

    public function setCategoryTreeVersion(?string $categoryTreeVersion): CategoryTreeVersion
    {
