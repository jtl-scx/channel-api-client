...
class Order implements ModelInterface, ArrayAccess
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['orderAcceptUntil'] = isset($data['orderAcceptUntil']) ? $data['orderAcceptUntil'] : null;
    ...
    /**
     * Gets orderAcceptUntil
     *
     * @return \DateTime|null
     */
    public function getOrderAcceptUntil()
    {
        return $this->container['orderAcceptUntil'];
    }

    /**
     * Sets orderAcceptUntil
     *
     * @param \DateTime|null $orderAcceptUntil When `orderStatus` is type `UNACKED` a Seller integration must confirn a Order bevor it can be proccessed. This field provides a time until when an order can be accepted. To accept an Order a Seller integration must invoke API call `PUT /v1/seller/order/accept`.
     *
     * @return $this
     */
    public function setOrderAcceptUntil($orderAcceptUntil)
    {
