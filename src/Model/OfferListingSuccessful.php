...
class OfferListingSuccessful implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function setSellerId(string $sellerId): OfferListingSuccessful
    {
    ...
    public function setOfferId(int $offerId): OfferListingSuccessful
    {
    ...
    public function setChannelOfferId(?string $channelOfferId): OfferListingSuccessful
    {
    ...
    public function setListedAt(\DateTime $listedAt): OfferListingSuccessful
    {
    ...
    public function setListingUrl(?string $listingUrl): OfferListingSuccessful
    {
