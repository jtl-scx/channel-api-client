 ...
 * @link     https://openapi-generator.tech
 */
class SellerEventReportRequest implements ModelInterface, ArrayAccess
{
    ...
    public function setSellerId($sellerId)
    {
        ...
        if ((!preg_match("/^\\w{1,50}$/", $sellerId))) {
            throw new \InvalidArgumentException("invalid value for $sellerId when calling SellerEventReportRequest., must conform to the pattern /^\\w{1,50}$/.");
        }
