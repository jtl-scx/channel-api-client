...
/**
 * ReturnProcessingError Class Doc Comment
 *
 * @category Class
 * @package  JTL\SCX\Client\Channel
 * @author   OpenAPI Generator team
 ...
 */
class ReturnProcessingError implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ReturnProcessingError';
    ...
    public function setCode(?string $code): ReturnProcessingError
    {
    ...
    public function setMessage(string $message): ReturnProcessingError
    {
