 ...
 */
class SupportedCarrier implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function setCarrierId(string $carrierId): SupportedCarrier
    {
    ...
    public function setDisplayName(?string $displayName): SupportedCarrier
    {
