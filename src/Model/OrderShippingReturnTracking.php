 ...
 */
class OrderShippingReturnTracking implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function setCarrier(string $carrier): OrderShippingReturnTracking
    {
    ...
    public function setTrackingNumber(string $trackingNumber): OrderShippingReturnTracking
    {
