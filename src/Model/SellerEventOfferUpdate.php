 ...
 */
class SellerEventOfferUpdate implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function setSellerId(string $sellerId): SellerEventOfferUpdate
    {
    ...
    public function setOfferId(int $offerId): SellerEventOfferUpdate
    {
    ...
    public function setParentOfferId(?int $parentOfferId): SellerEventOfferUpdate
    {
    ...
    public function setChannelOfferId(?string $channelOfferId): SellerEventOfferUpdate
    {
    ...
    public function setChannelCategoryId(?string $channelCategoryId): SellerEventOfferUpdate
    {
    ...
    public function setQuantity(?string $quantity): SellerEventOfferUpdate
    {
    ...
    public function setTaxPercent(?string $taxPercent): SellerEventOfferUpdate
    {
    ...
    public function setPriceList(array $priceList): SellerEventOfferUpdate
    {
    ...
    public function setTitle(?string $title): SellerEventOfferUpdate
    {
    ...
    public function setSubTitle(?string $subTitle): SellerEventOfferUpdate
    {
    ...
    public function setDescription(?string $description): SellerEventOfferUpdate
    {
    ...
    public function setMainPicture(?string $mainPicture): SellerEventOfferUpdate
    {
    ...
    public function setPictureList(?array $pictureList): SellerEventOfferUpdate
    {
    ...
    public function setChannelAttributeList(?array $channelAttributeList): SellerEventOfferUpdate
    {
    ...
    public function setVariationList(?array $variationList): SellerEventOfferUpdate
    {
    ...
    public function setSku(string $sku): SellerEventOfferUpdate
    {
    ...
    public function setGtin(?string $gtin): SellerEventOfferUpdate
    {
    ...
    public function setMpn(?string $mpn): SellerEventOfferUpdate
    {
    ...
    public function setIsbn(?string $isbn): SellerEventOfferUpdate
    {
    ...
    public function setBrand(?string $brand): SellerEventOfferUpdate
    {
    ...
    public function setSrp(?Price $srp): SellerEventOfferUpdate
    {
    ...
    public function setProductAttributeList(?array $productAttributeList): SellerEventOfferUpdate
    {
