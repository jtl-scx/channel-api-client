...
class OrderShippingShippedFrom implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function setCity(string $city): OrderShippingShippedFrom
    {
    ...
    public function setCountry(string $country): OrderShippingShippedFrom
    {
    ...
    public function setPostcode(string $postcode): OrderShippingShippedFrom
    {
