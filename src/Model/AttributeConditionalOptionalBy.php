...
class AttributeConditionalOptionalBy implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function setAttributeId(?string $attributeId): AttributeConditionalOptionalBy
    {
    ...
    public function setAttributeValues(?array $attributeValues): AttributeConditionalOptionalBy
    {
