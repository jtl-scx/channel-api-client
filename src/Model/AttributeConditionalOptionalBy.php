<?php
/**
 * AttributeConditionalOptionalBy
 *
 * PHP version 5
 *
 * @category Class
 ...
 * @link     https://openapi-generator.tech
 */
class AttributeConditionalOptionalBy implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Attribute_conditionalOptionalBy';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['attributeValues'] = isset($data['attributeValues']) ? $data['attributeValues'] : null;
    }
     ...
     * Sets attributeId
     *
     * @param string|null $attributeId AttributeId must be a category tree wide unique identifer.
     *
     * @return $this
     */
    public function setAttributeId($attributeId)
    {
        if (!is_null($attributeId) && (mb_strlen($attributeId) > 128)) {
            throw new \InvalidArgumentException('invalid length for $attributeId when calling AttributeConditionalOptionalBy., must be smaller than or equal to 128.');
        }
        if (!is_null($attributeId) && (mb_strlen($attributeId) < 1)) {
            throw new \InvalidArgumentException('invalid length for $attributeId when calling AttributeConditionalOptionalBy., must be bigger than or equal to 1.');
        }
     ...
     *
     * @param string[]|null $attributeValues attributeValues
     *
     * @return $this
     */
