...
class SellerEventOrderShipping implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function setShippingItems($shippingItems)
    {
        ...
        if ((count($shippingItems) < 1)) {
            throw new \InvalidArgumentException('invalid length for $shippingItems when calling SellerEventOrderShipping., number of items must be greater than or equal to 1.');
        }
