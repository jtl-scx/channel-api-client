 ...
 */
class SellerEventOrderShipping implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function setSellerId(string $sellerId): SellerEventOrderShipping
    {
    ...
    public function setOrderId(string $orderId): SellerEventOrderShipping
    {
    ...
    public function setShippingComplete(bool $shippingComplete): SellerEventOrderShipping
    {
    ...
    public function setShippingItems(array $shippingItems): SellerEventOrderShipping
    {
