...
class SellerEventOrderShipping implements ModelInterface, ArrayAccess
{
    ...
    protected static $openAPITypes = [
        ...
        'shipped_at' => '\DateTime',
        'shipping_items' => '\JTL\SCX\Client\Channel\Model\OrderShippingShippingItems[]'
    ];
    ...
    protected static $setters = [
        ...
        'order_id' => 'setOrderId',
        'shipping_complete' => 'setShippingComplete',
        'shipped_at' => 'setShippedAt',
        'shipping_items' => 'setShippingItems'
    ];
    ...
    protected static $getters = [
        ...
        'order_id' => 'getOrderId',
        'shipping_complete' => 'getShippingComplete',
        'shipped_at' => 'getShippedAt',
        'shipping_items' => 'getShippingItems'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['shipping_complete'] = isset($data['shipping_complete']) ? $data['shipping_complete'] : null;
        $this->container['shipped_at'] = isset($data['shipped_at']) ? $data['shipped_at'] : null;
        $this->container['shipping_items'] = isset($data['shipping_items']) ? $data['shipping_items'] : null;
    }
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['shipping_complete'] === null) {
            $invalidProperties[] = "'shipping_complete' can't be null";
        }
        if ($this->container['shipped_at'] === null) {
            $invalidProperties[] = "'shipped_at' can't be null";
        }
        if ($this->container['shipping_items'] === null) {
            $invalidProperties[] = "'shipping_items' can't be null";
        }
    ...
    public function setSellerId($seller_id)
    {
        ...
        if ((!preg_match("/^\\w{1,50}$/", $seller_id))) {
            throw new \InvalidArgumentException("invalid value for $seller_id when calling SellerEventOrderShipping., must conform to the pattern /^\\w{1,50}$/.");
        }
    ...
    /**
     * Gets shipping_complete
     *
     * @return bool
     */
    public function getShippingComplete()
    {
        return $this->container['shipping_complete'];
    }

    /**
     * Sets shipping_complete
     *
     * @param bool $shipping_complete When shipping is completed set to \"true\".
     *
     * @return $this
     */
    public function setShippingComplete($shipping_complete)
    {
        $this->container['shipping_complete'] = $shipping_complete;
     ...
     * Sets shipped_at
     *
     * @param \DateTime $shipped_at shipped_at
     *
     * @return $this
     */
    ...
    {
        return $this->container['shipping_items'];
    }

    /**
     * Sets shipping_items
     *
     * @param \JTL\SCX\Client\Channel\Model\OrderShippingShippingItems[] $shipping_items shipping_items
     *
     * @return $this
     */
    public function setShippingItems($shipping_items)
    {
        $this->container['shipping_items'] = $shipping_items;
