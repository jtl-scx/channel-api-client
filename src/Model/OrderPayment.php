...
class OrderPayment implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function setSellerId(string $sellerId): OrderPayment
    {
    ...
    public function setOrderId(string $orderId): OrderPayment
    {
    ...
    public function setPaymentComplete(bool $paymentComplete): OrderPayment
    {
    ...
    public function setPaidAt(\DateTime $paidAt): OrderPayment
    {
