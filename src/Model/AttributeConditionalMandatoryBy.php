 ...
 */
class AttributeConditionalMandatoryBy implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function setAttributeId($attributeId)
    {
        if (!is_null($attributeId) && (mb_strlen($attributeId) > 128)) {
            throw new \InvalidArgumentException('invalid length for $attributeId when calling AttributeConditionalMandatoryBy., must be smaller than or equal to 128.');
        }
        if (!is_null($attributeId) && (mb_strlen($attributeId) < 1)) {
            throw new \InvalidArgumentException('invalid length for $attributeId when calling AttributeConditionalMandatoryBy., must be bigger than or equal to 1.');
        }
