...
class AttributeConditionalMandatoryBy implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function setAttributeId(?string $attributeId): AttributeConditionalMandatoryBy
    {
    ...
    public function setAttributeValues(?array $attributeValues): AttributeConditionalMandatoryBy
    {
