 ...
 */
class RefundProcessingError implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function setCode(?string $code): RefundProcessingError
    {
    ...
    public function setMessage(string $message): RefundProcessingError
    {
