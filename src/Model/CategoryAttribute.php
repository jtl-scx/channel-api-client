...
class CategoryAttribute implements ModelInterface, ArrayAccess
{
    ...
    protected static $openAPITypes = [
        ...
        'conditionalMandantoryBy' => '\JTL\SCX\Client\Channel\Model\CategoryAttributeConditionalMandantoryBy',
        'conditionalOptionalBy' => '\JTL\SCX\Client\Channel\Model\CategoryAttributeConditionalOptionalBy',
        'required' => 'bool',
        'section' => 'string',
        'sectionPosition' => 'int',
        'subSection' => 'int',
    ...
    public function setAttributeId($attributeId)
    {
        if ((mb_strlen($attributeId) > 32)) {
            throw new \InvalidArgumentException('invalid length for $attributeId when calling CategoryAttribute., must be smaller than or equal to 32.');
        }
        if ((mb_strlen($attributeId) < 1)) {
            throw new \InvalidArgumentException('invalid length for $attributeId when calling CategoryAttribute., must be bigger than or equal to 1.');
        }
    ...
    public function setAttributeValueValidation($attributeValueValidation)
    {
        if (!is_null($attributeValueValidation) && (mb_strlen($attributeValueValidation) > 1024)) {
            throw new \InvalidArgumentException('invalid length for $attributeValueValidation when calling CategoryAttribute., must be smaller than or equal to 1024.');
        }
     ...
     *
     * @param \JTL\SCX\Client\Channel\Model\CategoryAttributeConditionalMandantoryBy|null $conditionalMandantoryBy conditionalMandantoryBy
     *
     * @return $this
     */
     ...
     *
     * @param \JTL\SCX\Client\Channel\Model\CategoryAttributeConditionalOptionalBy|null $conditionalOptionalBy conditionalOptionalBy
     *
     * @return $this
     */
