...
class OrderStatus implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['orderItems']) && (count($this->container['orderItems']) < 0)) {
    ...
    public function setOrderItems($orderItems)
    {
        ...
        if (!is_null($orderItems) && (count($orderItems) < 0)) {
            throw new \InvalidArgumentException('invalid length for $orderItems when calling OrderStatus., number of items must be greater than or equal to 0.');
        }
