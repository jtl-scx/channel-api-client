 ...
 */
class SellerEventOfferStockUpdate implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SellerEventOfferStockUpdate';
    ...
    public function setSellerId(string $sellerId): SellerEventOfferStockUpdate
    {
    ...
    public function setOfferId(int $offerId): SellerEventOfferStockUpdate
    {
    ...
    public function setChannelOfferId(?string $channelOfferId): SellerEventOfferStockUpdate
    {
    ...
    public function setQuantity(string $quantity): SellerEventOfferStockUpdate
    {
