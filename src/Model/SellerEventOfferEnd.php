...
class SellerEventOfferEnd implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function setSellerId(string $sellerId): SellerEventOfferEnd
    {
    ...
    public function setOfferId(int $offerId): SellerEventOfferEnd
    {
    ...
    public function setChannelOfferId(?string $channelOfferId): SellerEventOfferEnd
    {
