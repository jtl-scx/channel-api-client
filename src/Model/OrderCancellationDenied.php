 ...
 */
class OrderCancellationDenied implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function setSellerId(string $sellerId): OrderCancellationDenied
    {
    ...
    public function setOrderCancellationRequestId(string $orderCancellationRequestId): OrderCancellationDenied
    {
    ...
    public function setReason(string $reason): OrderCancellationDenied
    {
