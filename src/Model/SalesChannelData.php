...
class SalesChannelData implements ModelInterface, ArrayAccess
{
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['support_contact'] === null) {
            $invalidProperties[] = "'support_contact' can't be null";
        }
        if ($this->container['vendor'] === null) {
            $invalidProperties[] = "'vendor' can't be null";
        }
        if ($this->container['sign_up_url'] === null) {
            $invalidProperties[] = "'sign_up_url' can't be null";
        }
     ...
     * Sets display_name
     *
     * @param string $display_name Channel Name
     *
     * @return $this
     */
     ...
     *
     * @param string $support_contact support_contact
     *
     * @return $this
     */
     ...
     * Sets sign_up_url
     *
     * @param string $sign_up_url The SignUp URL ist required for register new Sellers with the SCX Channel API. SCX will create a Sign-Up ID to link a seller with SCX.
     *
     * @return $this
     */
