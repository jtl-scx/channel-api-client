...
class OrderItem implements ModelInterface, ArrayAccess
{
    ...
    public function setOrderItemId($orderItemId)
    {
        ...
        if ((mb_strlen($orderItemId) < 1)) {
            throw new \InvalidArgumentException('invalid length for $orderItemId when calling OrderItem., must be bigger than or equal to 1.');
        }
    ...
    public function setSku($sku)
    {
        if (!is_null($sku) && (mb_strlen($sku) > 150)) {
            throw new \InvalidArgumentException('invalid length for $sku when calling OrderItem., must be smaller than or equal to 150.');
        }
