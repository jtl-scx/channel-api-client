 ...
 */
class OrderCancellationItem implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function setOrderItemId(string $orderItemId): OrderCancellationItem
    {
    ...
    public function setQuantity(?string $quantity): OrderCancellationItem
    {
