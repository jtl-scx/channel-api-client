...
/**
 * @covers \JTL\SCX\Client\Channel\Api\Order\Response\RequestOrderCancellationResponse
 */
class RequestOrderCancellationResponseTest extends TestCase
{
    /**
     * @test
     */
    ...
    {
        $sut = new RequestOrderCancellationResponse(201);
    ...
    {
        $sut = new RequestOrderCancellationResponse(200);
