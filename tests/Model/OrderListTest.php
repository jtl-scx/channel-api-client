 ...
 * @author      OpenAPI Generator team
 * @link        https://openapi-generator.tech
 * @covers      \JTL\SCX\Client\Channel\Model\OrderList
 */
class OrderListTest extends TestCase
{
    ...
    {
        $sample = $this->buildSampleForDataType('\JTL\SCX\Client\Channel\Model\Order[]');
        $sut = new OrderList(['orderList' => $sample]);
    ...
    private function assertMethodExists(OrderList $sut, string $methodName): void
    {
        try {
