...
/**
 * OrderShippingPositionItemTest Class Doc Comment
 *
 * @category    Class
 * @description OrderShippingPositionItem
 * @package     JTL\SCX\Client\Channel
 * @author      OpenAPI Generator team
 * @link        https://openapi-generator.tech
 * @covers      \JTL\SCX\Client\Channel\Model\OrderShippingPositionItem
 */
class OrderShippingPositionItemTest extends TestCase
{
    ...
    public function it_has_a_OrderItemId(): void
    {
        ...
        $sut = new OrderShippingPositionItem(['orderItemId' => $sample]);
    ...
    {
        $sample = $this->buildSampleForDataType('string');
        $sut = new OrderShippingPositionItem();
    ...
    public function it_has_a_Quantity(): void
    {
        ...
        $sut = new OrderShippingPositionItem(['quantity' => $sample]);
    ...
    private function assertMethodExists(OrderShippingPositionItem $sut, string $methodName): void
    {
        try {
