...
/**
 * OrderAddressUpdateListTest Class Doc Comment
 *
 * @category    Class
 * @description OrderAddressUpdateList
 * @package     JTL\SCX\Client\Channel
 * @author      OpenAPI Generator team
 * @link        https://openapi-generator.tech
 * @covers      \JTL\SCX\Client\Channel\Model\OrderAddressUpdateList
 */
class OrderAddressUpdateListTest extends TestCase
{
    ...
    {
        $sample = $this->buildSampleForDataType('\JTL\SCX\Client\Channel\Model\OrderAddressUpdate[]');
        $sut = new OrderAddressUpdateList(['orderList' => $sample]);
    ...
    {
        $sample = $this->buildSampleForDataType('\JTL\SCX\Client\Channel\Model\OrderAddressUpdate[]');
        $sut = new OrderAddressUpdateList();
    ...
    private function assertMethodExists(OrderAddressUpdateList $sut, string $methodName): void
    {
        try {
