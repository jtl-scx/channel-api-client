...
/**
 * ReturnReceivedTest Class Doc Comment
 *
 * @category    Class
 ...
 * @author      OpenAPI Generator team
 * @link        https://openapi-generator.tech
 * @covers      \JTL\SCX\Client\Channel\Model\ReturnReceived
 */
class ReturnReceivedTest extends TestCase
{
    ...
    public function it_has_a_SellerId(): void
    {
        ...
        $sut = new ReturnReceived(['sellerId' => $sample]);
    ...
    {
        $sample = $this->buildSampleForDataType('string');
        $sut = new ReturnReceived(['orderId' => $sample]);
    ...
    {
        $sample = $this->buildSampleForDataType('string');
        $sut = new ReturnReceived(['sellerReturnId' => $sample]);
    ...
    {
        $sample = $this->buildSampleForDataType('string');
        $sut = new ReturnReceived(['channelReturnId' => $sample]);
    ...
    public function it_has_a_OrderItem(): void
    {
        ...
        $sut = new ReturnReceived(['orderItem' => $sample]);
    ...
    private function assertMethodExists(ReturnReceived $sut, string $methodName): void
    {
        try {
