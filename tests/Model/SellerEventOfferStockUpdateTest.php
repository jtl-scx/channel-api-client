<?php
/**
 * SellerEventOfferStockUpdateTest
 *
 * PHP version 7.2
 *
 * @category Class
...
/**
 * SellerEventOfferStockUpdateTest Class Doc Comment
 *
 * @category    Class
 ...
 * @author      OpenAPI Generator team
 * @link        https://openapi-generator.tech
 * @covers      \JTL\SCX\Client\Channel\Model\SellerEventOfferStockUpdate
 */
class SellerEventOfferStockUpdateTest extends TestCase
{
    ...
    public function it_has_a_SellerId(): void
    {
        ...
        $sut = new SellerEventOfferStockUpdate(['sellerId' => $sample]);
    ...
    {
        $sample = $this->buildSampleForDataType('string');
        $sut = new SellerEventOfferStockUpdate();
    ...
    public function it_has_a_OfferId(): void
    {
        ...
        $sut = new SellerEventOfferStockUpdate(['offerId' => $sample]);
    ...
    {
        $sample = $this->buildSampleForDataType('string');
        $sut = new SellerEventOfferStockUpdate(['channelOfferId' => $sample]);
    ...
    {
        $sample = $this->buildSampleForDataType('string');
        $sut = new SellerEventOfferStockUpdate(['quantity' => $sample]);
    ...
    private function assertMethodExists(SellerEventOfferStockUpdate $sut, string $methodName): void
    {
        try {
