...
/**
 * ChannelNotificationTest Class Doc Comment
 *
 * @category    Class
 * @description ChannelNotification
 * @package     JTL\SCX\Client\Channel
 * @author      OpenAPI Generator team
 * @link        https://openapi-generator.tech
 * @covers      \JTL\SCX\Client\Channel\Model\ChannelNotification
 */
class ChannelNotificationTest extends TestCase
{
    ...
    public function it_has_a_SellerId(): void
    {
        ...
        $sut = new ChannelNotification(['sellerId' => $sample]);
    ...
    public function it_has_a_Severity(): void
    {
        ...
        $sut = new ChannelNotification(['severity' => $sample]);
    ...
    {
        $sample = $this->buildSampleForDataType('string');
        $sut = new ChannelNotification(['message' => $sample]);
    ...
    public function it_has_a_Reference(): void
    {
        ...
        $sut = new ChannelNotification(['reference' => $sample]);
    ...
    private function assertMethodExists(ChannelNotification $sut, string $methodName): void
    {
        try {
