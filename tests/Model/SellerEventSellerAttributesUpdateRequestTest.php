<?php
/**
 * SellerEventSellerAttributesUpdateRequestTest
 *
 * PHP version 7.2
 *
 * @category Class
...
/**
 * SellerEventSellerAttributesUpdateRequestTest Class Doc Comment
 *
 * @category    Class
 * @description SellerEventSellerAttributesUpdateRequest
 * @package     JTL\SCX\Client\Channel
 * @author      OpenAPI Generator team
 * @link        https://openapi-generator.tech
 * @covers      \JTL\SCX\Client\Channel\Model\SellerEventSellerAttributesUpdateRequest
 */
class SellerEventSellerAttributesUpdateRequestTest extends TestCase
{
    ...
    public function it_has_a_SellerId(): void
    {
        ...
        $sut = new SellerEventSellerAttributesUpdateRequest(['sellerId' => $sample]);
    ...
    {
        $sample = $this->buildSampleForDataType('string');
        $sut = new SellerEventSellerAttributesUpdateRequest();
    ...
    private function assertMethodExists(SellerEventSellerAttributesUpdateRequest $sut, string $methodName): void
    {
        try {
