<?php
/**
 * SellerEventOrderCancellationAcceptedTest
 *
 * PHP version 7.2
 *
 * @category Class
...
/**
 * SellerEventOrderCancellationAcceptedTest Class Doc Comment
 *
 * @category    Class
 * @description SellerEventOrderCancellationAccepted
 * @package     JTL\SCX\Client\Channel
 * @author      OpenAPI Generator team
 * @link        https://openapi-generator.tech
 * @covers      \JTL\SCX\Client\Channel\Model\SellerEventOrderCancellationAccepted
 */
class SellerEventOrderCancellationAcceptedTest extends TestCase
{
    ...
    public function it_has_a_SellerId(): void
    {
        ...
        $sut = new SellerEventOrderCancellationAccepted(['sellerId' => $sample]);
    ...
    {
        $sample = $this->buildSampleForDataType('string');
        $sut = new SellerEventOrderCancellationAccepted();
    ...
    {
        $sample = $this->buildSampleForDataType('string');
        $sut = new SellerEventOrderCancellationAccepted(['orderCancellationRequestId' => $sample]);
    ...
    private function assertMethodExists(SellerEventOrderCancellationAccepted $sut, string $methodName): void
    {
        try {
