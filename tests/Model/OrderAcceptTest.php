...
/**
 * OrderAcceptTest Class Doc Comment
 *
 * @category    Class
 * @description OrderAccept
 * @package     JTL\SCX\Client\Channel
 * @author      OpenAPI Generator team
 * @link        https://openapi-generator.tech
 * @covers      \JTL\SCX\Client\Channel\Model\OrderAccept
 */
class OrderAcceptTest extends TestCase
{
    ...
    public function it_has_a_SellerId(): void
    {
        ...
        $sut = new OrderAccept(['sellerId' => $sample]);
    ...
    {
        $sample = $this->buildSampleForDataType('string');
        $sut = new OrderAccept(['orderId' => $sample]);
    ...
    public function it_has_a_OrderAccepted(): void
    {
        ...
        $sut = new OrderAccept(['orderAccepted' => $sample]);
    ...
    public function it_has_a_Reason(): void
    {
        ...
        $sut = new OrderAccept(['reason' => $sample]);
    ...
    private function assertMethodExists(OrderAccept $sut, string $methodName): void
    {
        try {
